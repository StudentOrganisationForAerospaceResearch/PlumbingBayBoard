...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, TC1_CS__Pin|TC2_CS__Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TC1_CS__Pin TC2_CS__Pin */
  GPIO_InitStruct.Pin = TC1_CS__Pin|TC2_CS__Pin;
